...
namespace JestersCreditUnion.Data.Internal
{
    public class LoanApplicationDataSaver : DataSaverBase, ILoanApplicationDataSaver
    {
        ...
        private void AddCommonParameters(IList commandParameters, LoanApplicationData data)
        {
            ...
            DataUtil.AddParameter(_providerFactory, commandParameters, "borrowerIdentificationCardName", DbType.AnsiString, DataUtil.GetParameterValue(data.BorrowerIdentificationCardName));
