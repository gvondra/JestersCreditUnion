...
namespace JestersCreditUnion.Loan.Data
{
    public interface IPaymentIntakeDataSaver
    {
        ...
        Task Commit(ITransactionHandler transactionHandler, short intakeStatusFilter, DateTime maxTimestamp, short intakeStatus, short paymentStatus, string userId);
    }
}
