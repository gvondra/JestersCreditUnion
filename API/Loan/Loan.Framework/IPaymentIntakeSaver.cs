...
namespace JestersCreditUnion.Loan.Framework
{
    ...
    {
        Task Commit(ISettings settings, PaymentIntakeStatus intakeStatusFilter, DateTime maxTimestamp, PaymentIntakeStatus intakeStatus, PaymentStatus paymentStatus, string userId);
